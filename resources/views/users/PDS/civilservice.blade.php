...
@section('content')
    ...
    <div class="row">
        <div class="col text-start">
            <a href="{{ route('users.pds.educational.index') }}" class="btn btn-outline-success">Educational Background<i class="fa-solid fa-chevron-left ms-2"></i></a>
        </div>
        <div class="col text-center">
            <strong>Go to</strong>
        </div>
        <div class="col text-end">
            <a href="{{ route('users.pds.workexperience.index') }}" class="btn btn-outline-success"><i class="fa-solid fa-chevron-right me-2"></i>Work Experience</a>
        </div>
    </div>
    <hr>
