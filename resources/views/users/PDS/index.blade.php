    ...
    <div class="row mt-3">
        <div class="col">
            <div class="row mt-2">
                ...
                <div class="col-sm-6 col-md-3 my-2 mt-sm-2 mt-md-0 small">
                    <a href="{{ route('users.pds.educational.index') }}" class="btn btn-outline-success w-100 bg-gradient h-100 text-start text-center">
                        <i class="fa-solid fa-user-graduate py-3 fs-2 me-1"></i><br>Educational Background
                    </a>
                </div>
                <div class="col-sm-6 col-md-3 my-2 mt-sm-2 mt-md-0 small">
                    <a href="{{ route('users.pds.civilservice.index') }}" class="btn btn-outline-success w-100 bg-gradient h-100 text-start text-center">
            ...
            <div class="row mt-2">
                <div class="col-sm-6 col-md-3 my-2 mt-sm-2 mt-md-0 small">
                    <a href="{{ route('users.pds.workexperience.index') }}" class="btn btn-outline-success w-100 bg-gradient h-100 text-start text-center">
                        <i class="fa-solid fa-building-user py-3 fs-2 me-1"></i><br>Work Experience
                    </a>
                </div>
                <div class="col-sm-6 col-md-3 my-2 mt-sm-2 mt-md-0 small">
                    <a href="{{ route('users.pds.voluntarywork.index') }}" class="btn btn-outline-success w-100 bg-gradient h-100 text-start text-center">
                        <i class="fa-solid fa-people-carry-box  py-3 fs-2 me-1"></i><br>Voluntary Work
                    </a>
                </div>
                <div class="col-sm-6 col-md-3 my-2 mt-sm-2 mt-md-0 small">
                    <a href="{{ route('users.pds.learningdevelopment.index') }}" class="btn btn-outline-success w-100 bg-gradient h-100 text-start text-center">
                        <i class="fa-solid fa-person-chalkboard  py-3 fs-2 me-1"></i><br>Learning and Development
                    </a>
                </div>
                <div class="col-sm-6 col-md-3 my-2 mt-sm-2 mt-md-0 small">
                    <a href="{{ route('users.pds.otherinformation.index') }}" class="btn btn-outline-success w-100 bg-gradient h-100 text-start text-center">
            ...
            <div class="row mt-2">
                <div class="col">
                    <a href="{{ route('users.pds.other.index') }}" class="btn btn-outline-success w-100 bg-gradient h-100 text-start text-center">
