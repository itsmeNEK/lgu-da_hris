                                ...
                                <div class="col-8">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="invalidCheck">
                                            Agree to <a type="button" href="#" data-bs-toggle="modal"
                                                data-bs-target="#privacy_policy">
                                                Privacy Policy
                                            </a> and <a type="button" href="#" data-bs-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Permission is granted to temporarily download one copy of the materials on LGU Delfin Albano's Website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:</p>
                    ...
                    <p>This will let LGU Delfin Albano to terminate upon violations of any of these restrictions. Upon termination, your viewing right will also be terminated and you should destroy any downloaded materials in your possession whether it is printed or electronic format.</p>

                    <h2>3. Disclaimer</h2>

                    <p>All the materials on LGU Delfin Albano’s Website are provided "as is". LGU Delfin Albano makes no warranties, may it be expressed or implied, therefore negates all other warranties. Furthermore, LGU Delfin Albano does not make any representations concerning the accuracy or reliability of the use of the materials on its Website or otherwise relating to such materials or any sites linked to this Website.</p>

                    <h2>4. Limitations</h2>

                    <p>LGU Delfin Albano or its suppliers will not be hold accountable for any damages that will arise with the use or inability to use the materials on LGU Delfin Albano’s Website, even if LGU Delfin Albano or an authorize representative of this Website has been notified, orally or written, of the possibility of such damage. Some jurisdiction does not allow limitations on implied warranties or limitations of liability for incidental damages, these limitations may not apply to you.</p>

                    <h2>5. Revisions and Errata</h2>

                    <p>The materials appearing on LGU Delfin Albano’s Website may include technical, typographical, or photographic errors. LGU Delfin Albano will not promise that any of the materials in this Website are accurate, complete, or current. LGU Delfin Albano may change the materials contained on its Website at any time without notice. LGU Delfin Albano does not make any commitment to update the materials.</p>

                    <h2>6. Links</h2>

                    <p>LGU Delfin Albano has not reviewed all of the sites linked to its Website and is not responsible for the contents of any such linked site. The presence of any link does not imply endorsement by LGU Delfin Albano of the site. The use of any linked website is at the user’s own risk.</p>

                    <h2>7. Site Terms of Use Modifications</h2>

                    <p>LGU Delfin Albano may revise these Terms of Use for its Website at any time without prior notice. By using this Website, you are agreeing to be bound by the current version of these Terms and Conditions of Use.</p>
                    ...
                    <p>Any claim related to LGU Delfin Albano's Website shall be governed by the laws of ph without regards to its conflict of law provisions.</p>
