            ...
            <div class="row mb-3">
                <form action="{{ route('hr.service.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control text-uppercase" name="from" id="from" value="{{ old('') }}">
                        ...
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control text-uppercase" name="to" id="to" value="{{ old('to') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control text-uppercase" name="status" id="status" placeholder="Status" value="{{ old('status') }}">
                        ...
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control text-uppercase" name="salary" id="salary" placeholder="Salary" value="{{ old('salary') }}">
                        ...
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control text-uppercase" name="station" id="station" placeholder="Station/Place/Branch" value="{{ old('station') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control text-uppercase" name="wo_pay" id="wo_pay" placeholder="L/V ABS W/O PAy" value="{{ old('wo_pay') }}">
                        ...
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control text-uppercase" name="date" id="date" placeholder="Date" value="{{ old('') }}">
                        ...
                        <div class="col-12 col-md mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control text-uppercase" name="cause" id="cause" placeholder="Cause" value="{{ old('cause') }}">
